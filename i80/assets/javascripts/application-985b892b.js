...
function(t) {
    ...
    e.prototype.checkPosition = function() {
        if (this.$element.is(":visible")) {
            ...
            if (this.affixed !== l) {
                ...
                c.isDefaultPrevented() || (this.affixed = l, this.unpin = "bottom" == l ? this.getPinnedOffset() : null, this.$element.removeClass(e.RESET).addClass(h).trigger(t.Event(h.replace("affix", "affixed"))), "bottom" == l && this.$element.offset({
                    top: s.top
                }))
            }
        }
    ...
    t.fn.affix = function(i) {
        return this.each(function() {
            ...
            s = o.data("bs.affix"),
            n = "object" == typeof i && i;
            s || o.data("bs.affix", s = new e(this, n)),
            "string" == typeof i && s[i]()
        })
    },
...
function(t) {
    ...
    i.prototype.close = function(e) {
        ...
        e.isDefaultPrevented() || (n.removeClass("in"), t.support.transition && n.hasClass("fade") ? n.one(t.support.transition.end, i).emulateTransitionEnd(150) : i())
    };
    var o = t.fn.alert;
...
function(t) {
    ...
    e.prototype.setState = function(e) {
        ...
        n = o.data();
        e += "Text",
        n.resetText || o.data("resetText", o[s]()),
        o[s](n[e] || this.options[e]),
    ...
    t.fn.button = function(i) {
        return this.each(function() {
            ...
            s = o.data("bs.button"),
            n = "object" == typeof i && i;
            s || o.data("bs.button", s = new e(this, n)),
...
function(t) {
    ...
    e.prototype.slide = function(e, i) {
        ...
        h.isDefaultPrevented() ? void 0 : (this.sliding = !0, n && this.pause(), this.$indicators.length && (this.$indicators.find(".active").removeClass("active"), this.$element.one("slid.bs.carousel",
        function() {
            var e = t(l.$indicators.children()[l.getActiveIndex()]);
            e && e.addClass("active")
        })), t.support.transition && this.$element.hasClass("slide") ? (s.addClass(e), s[0].offsetWidth, o.addClass(a), s.addClass(a), o.one(t.support.transition.end,
        function() {
    ...
    t.fn.carousel = function(i) {
        return this.each(function() {
            ...
            s || o.data("bs.carousel", s = new e(this, n)),
            "number" == typeof i ? s.to(i) : a ? s[a]() : n.interval && s.pause().cycle()
        })
    },
    ...
    function(e) {
        ...
        a && (n.interval = !1),
        s.carousel(n),
        (a = o.attr("data-slide-to")) && s.data("bs.carousel").to(a),
        e.preventDefault()
    }),
    t(window).on("load",
    function() {
...
function(t) {
    ...
    t.fn.collapse = function(i) {
        return this.each(function() {
            ...
            n = t.extend({},
            e.DEFAULTS, o.data(), "object" == typeof i && i); ! s && n.toggle && "show" == i && (i = !i),
            s || o.data("bs.collapse", s = new e(this, n)),
            "string" == typeof i && s[i]()
        })
    },
    ...
    function(e) {
        ...
        h = l && t(l);
        a && a.transitioning || (h && h.find('[data-toggle="collapse"][data-parent="' + l + '"]').not(o).addClass("collapsed"), o[n.hasClass("in") ? "addClass": "removeClass"]("collapsed")),
        n.collapse(r)
    })
} (jQuery),
/* ========================================================================
    ...
    n.prototype.keydown = function(e) {
        if (/(38|40|27)/.test(e.keyCode)) {
            ...
            if (e.preventDefault(), e.stopPropagation(), !o.is(".disabled, :disabled")) {
                var n = i(o),
                a = n.hasClass("open");
                if (!a || a && 27 == e.keyCode) return 27 == e.which && n.find(s).trigger("focus"),
                o.trigger("click");
...
function(t) {
    ...
    e.prototype.activate = function(e, i, o) {
        ...
        a ? n.one(t.support.transition.end, s).emulateTransitionEnd(150) : s(),
        n.removeClass("in")
    };
    var i = t.fn.tab;
    t.fn.tab = function(i) {
...
function(t) {
    ...
    function e(i, o) {
        ...
        this.$body = t("body"),
        this.$scrollElement = this.$element.on("scroll.bs.scrollspy", n),
        this.options = t.extend({},
        e.DEFAULTS, o),
        this.selector = (this.options.target || (s = t(i).attr("href")) && s.replace(/.*(?=#[^\s]+$)/, "") || "") + " .nav li > a",
        this.offsets = t([]),
        this.targets = t([]),
...
function(t) {
    ...
    t.fn.modal = function(i, o) {
        return this.each(function() {
            ...
            n = s.data("bs.modal"),
            a = t.extend({},
            e.DEFAULTS, s.data(), "object" == typeof i && i);
            n || s.data("bs.modal", n = new e(this, a)),
            "string" == typeof i ? n[i](o) : a.show && n.show(o)
        })
    },
...
function(t) {
    ...
    e.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (a) {
                ...
                s = "bottom" == s && r.top + r.height + h - p.scroll > p.height ? "top": "top" == s && r.top - p.scroll - h < 0 ? "bottom": "right" == s && r.right + l > p.width ? "left": "left" == s && r.left - l < p.left ? "right": s,
    ...
    e.prototype.hide = function() {
        ...
        s.isDefaultPrevented() ? void 0 : (o.removeClass("in"), t.support.transition && this.$tip.hasClass("fade") ? o.one(t.support.transition.end, e).emulateTransitionEnd(150) : e(), this.hoverState = null, this)
    },
    ...
    t.fn.tooltip = function(i) {
        return this.each(function() {
            var o = t(this),
            s = o.data("bs.tooltip"),
            n = "object" == typeof i && i; (s || "destroy" != i) && (s || o.data("bs.tooltip", s = new e(this, n)), "string" == typeof i && s[i]())
        })
    },
...
function(t) {
    ...
    t.fn.popover = function(i) {
        return this.each(function() {
            var o = t(this),
            s = o.data("bs.popover"),
            n = "object" == typeof i && i; (s || "destroy" != i) && (s || o.data("bs.popover", s = new e(this, n)), "string" == typeof i && s[i]())
        })
    },
...
function(t, e) {
    ...
    function s(t, i, s) {
        return i || (i = e),
        l ? i.createElement(t) : (s || (s = o(i)), i = s.cache[t] ? s.cache[t].cloneNode() : d.test(t) ? (s.cache[t] = s.createElem(t)).cloneNode() : s.createElem(t), i.canHaveChildren && !c.test(t) ? s.frag.appendChild(i) : i)
    }
    function n(t, e) {
        e.cache || (e.cache = {},
    ...
    function a(t) {
        ...
        if (g.shivCSS && !r && !i.hasCSS) {
            ...
            s.innerHTML = "x<style>article,aside,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}</style>",
            s = a.insertBefore(s.lastChild, a.firstChild),
            i.hasCSS = !!s
        }
        return l || n(t, i),
        t
...
function(t) {
    ...
    e.o = function() {
        ...
        this.run = function() {
            ...
            this.c ? (this.$.wrap(t('<div style="' + (this.o.inline ? "display:inline;": "") + "width:" + this.o.width + "px;height:" + this.o.height + 'px;"></div>')).before(this.$c), this.scale = (window.devicePixelRatio || 1) / (this.c.webkitBackingStorePixelRatio || this.c.mozBackingStorePixelRatio || this.c.msBackingStorePixelRatio || this.c.oBackingStorePixelRatio || this.c.backingStorePixelRatio || 1), 1 !== this.scale && (this.$c[0].width = this.$c[0].width * this.scale, this.$c[0].height = this.$c[0].height * this.scale, this.$c.width(this.o.width), this.$c.height(this.o.height)), this.v instanceof Object ? (this.cv = {},
            this.copy(this.v, this.cv)) : this.cv = this.v, this.$.bind("configure", e).parent().bind("configure", e), this._listen()._configure()._xy().init(), this.isInit = !0, this._draw(), this) : void(this.o.error && this.o.error())
        },
        this._draw = function() {
            var t = !0,
            e = document.createElement("canvas");
            e.width = i.o.width * i.scale,
            e.height = i.o.height * i.scale,
            i.g = e.getContext("2d"),
            i.clear(),
            i.dH && (t = i.dH()),
            t !== !1 && i.draw(),
        ...
        this._touch = function(t) {
            ...
            o(t),
            e.c.d.bind("touchmove.k", o).bind("touchend.k",
            function() {
        ...
        this._mouse = function(t) {
            ...
            return o(t),
            e.c.d.bind("mousemove.k", o).bind("keyup.k",
            function(t) {
                if (27 === t.keyCode) {
    ...
    e.Dial = function() {
        ...
        this.xy2val = function(t, e) {
            ...
            n = ~~ (.5 + s * (this.o.max - this.o.min) / this.angleArc) + this.o.min,
            this.o.stopper && (n = i(o(n, this.o.max), this.o.min)),
            n
        },
        this.listen = function() {
            var e, s, n = this,
            ...
            function(a) {
                ...
                if (h >= 96 && 105 >= h && (h = a.keyCode = h - 48), e = parseInt(String.fromCharCode(h)), isNaN(e) && (13 !== h && 8 !== h && 9 !== h && 189 !== h && a.preventDefault(), t.inArray(h, [37, 38, 39, 40]) > -1)) {
                    ...
                    n.o.stopper && (c = i(o(c, n.o.max), n.o.min)),
                    n.change(c),
                    n._draw(),
        ...
        this.draw = function() {
            ...
            this.o.cursor && (s = n - this.cursorExt) && (n += this.cursorExt),
            i.beginPath(),
            i.strokeStyle = this.o.bgColor,
            i.arc(this.xy, this.xy, this.radius, this.endAngle, this.startAngle, !0),
            i.stroke(),
            this.o.displayPrevious && (e = this.startAngle + this.angle(this.v), t = this.startAngle, this.o.cursor && (t = e - this.cursorExt) && (e += this.cursorExt), i.beginPath(), i.strokeStyle = this.pColor, i.arc(this.xy, this.xy, this.radius, t, e, !1), i.stroke(), a = this.cv == this.v),
            i.beginPath(),
            i.strokeStyle = a ? this.o.fgColor: this.fgColor,
            i.arc(this.xy, this.xy, this.radius, s, n, !1),
            i.stroke()
        },
...
function() {
    ...
    i = ["assert", "clear", "count", "debug", "dir", "dirxml", "error", "exception", "group", "groupCollapsed", "groupEnd", "info", "log", "markTimeline", "profile", "profileEnd", "table", "time", "timeEnd", "timeStamp", "trace", "warn"], o = i.length, s = window.console = window.console || {}; o--;) t = i[o],
    s[t] || (s[t] = e)
} (),
function() {
    $(document).ready(function() {
        ...
        $("#toggle").click(function() {
            return $("#dock .launcher a").toggle(),
            $("#dock li.launcher").each(function() {
